...
<header className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4" style={{ color: isDarkMode ? themeColors.colors.pink[300] : themeColors.colors.pink[600] }}>Get in Touch 🌸</h1>
          <p className="text-lg" style={{ color: themeColors.text.secondary }}>Feel free to reach out — whether it's about EdTech, AI projects, or just to say hi!
          </p>
        </header>
